  ...
  return (
    <div>
      ...
      {loading?(<div style={{textAlign:'center',padding:'40px 20px',color:'rgba(255,255,255,0.3)',fontSize:13}}>⏳ Chargement…</div>):videos.length===0?(
        <div style={{...card,textAlign:'center',padding:'40px 20px',background:'linear-gradient(135deg,rgba(126,3,128,0.52),rgba(237,7,15))',border:'none'}}><div style={{fontSize:40,marginBottom:12}}>🎬</div><p style={{color:'rgba(255,255,255,0.5)',fontSize:14,marginBottom:16}}>Tu n'as pas encore ajouté de vidéo.</p><button onClick={()=>router.push('/submit')} style={btnPrimary}>Ajouter ma première vidéo</button></div>
      ):(
        <>
