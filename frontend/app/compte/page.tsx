  ...
  return (
    <div>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12}}>
        <div style={{...card,textAlign:'center',background:'linear-gradient(135deg,rgba(126,3,128,0.52),rgba(237,7,15))',border:'none'}}><div style={{fontSize:28,marginBottom:10}}>⚡</div><div style={{fontSize:14,fontWeight:700,color:'#fff',marginBottom:6}}>Recharger</div><div style={{fontSize:11,color:'rgba(255,255,255,0.4)',marginBottom:14,lineHeight:1.5}}>Acheter des étoiles et cœurs via FedaPay, MTN, Moov.</div><button onClick={()=>router.push('/recharge')} style={btnPrimary}>Recharger mon compte</button></div>
