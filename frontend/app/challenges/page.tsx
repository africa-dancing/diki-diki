      ...
      <div style={{ maxWidth:700, margin:'0 auto', padding:'24px 16px' }}>
        ...
        <div style={{ background:'linear-gradient(135deg,rgba(126,3,128,0.52),rgba(237,7,15))', border:'1px solid rgb(10,0,0)', borderRadius:16, padding:'20px', marginBottom:20, textAlign:'center' as const }}>
          ...
          <div style={{ fontSize:12, color:'#fff', lineHeight:1.6 }}>
            {/*DKDK_BANDEAU*/}Podium Challenges {'\u00B7'} Parcours d{'\u2019'}{'\u00E9'}tapes ({'\u00E9'}limination progressive) ou Bloc group{'\u00E9'} (classement final) {'\u00B7'} 6 formats {'\u00B7'} toute participation m{'\u00E9'}rite un encouragement
          </div>
        </div>
