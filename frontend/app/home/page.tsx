...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <div style={{ padding: '44px 24px 44px', background: 'radial-gradient(ellipse 80% 60% at 50% -10%,rgba(126,3,128,0.92) 0%,rgba(237,7,15,0.55) 40%,transparent 72%)', textAlign: 'center' }}>
      </div>
